...
const ProblemCard: React.FC<ProblemCardProps> = ({ questionId , title, difficulty, platform, link }) => {
  ...
  const platformLogo = {
    leetcode: (
      <svg xmlns="http://www.w3.org/2000/svg" enable-background="0 0" viewBox=" " id="leetcode">
      ...
      <CardBody>
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          ...
          <div style={{ width: '24px', height: '24px' }}>
            {platformLogo[platform.toLowerCase()]}
          </div>
          
          {/* Title and Difficulty */}
          <div style={{ flex: 1 }}>
            <Link href={link} isExternal>
              <h3 style={{ margin: 0, fontSize: '1.2rem', fontWeight: 'bold' }}>{questionId}.{title}</h3>
            </Link>
          </div>
